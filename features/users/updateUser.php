                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="username"
                                        value="<?php echo $dataDetail['username']; ?>" placeholder="Username" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <img src="images/<?php echo $dataDetail['foto']; ?> " width="50" height="50" alt="">
                                    </div>
                                    <div class="form-group">
...
if (isset($_POST['create'])) {
    ...
    if (!empty($lokasi)) {
        ...
        $sql = $connect_db->query("UPDATE tbl_users SET nik='$nik', nama='$nama', alamat='$alamat', no_telp='$no_telp', username='$username', foto='$foto' WHERE id='$id'");
        ...
        $sql = $connect_db->query("UPDATE tbl_users SET nik='$nik', nama='$nama', alamat='$alamat', no_telp='$no_telp', username='$username' WHERE id='$id'");
        if ($sql) {
            ?>
            <script type="text/javascript">
                alert("Updating data success");
