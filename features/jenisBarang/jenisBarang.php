              ...
              <div class="card card-rounded">
                <div class="card-body">
                  ...
                  <div class="text-white" style="text-align: end;">
                    <a href="?page=jenisBarang&aksi=createJenisBarang" class="btn btn-primary me-2">
                      Add
                    </a>
                  </div>
                  <div class="table-responsive  mt-1">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                        $no = 1;
                        $sql = $connect_db->query("SELECT * FROM `tbl_jenis`");
                        while ($data = $sql->fetch_assoc()) {
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="?page=jenisBarang&aksi=updateJenisBarang&id=<?php echo $data['id'] ?>" type="button"
                                class="btn btn-info btn-icon p-2">
                                <i class="mdi mdi-pencil menu-icon m-0"></i>
                              </a>
                              <a href="?page=jenisBarang&aksi=deleteJenisBarang&id=<?php echo $data['id'] ?>" class="btn btn-danger btn-icon p-2">
